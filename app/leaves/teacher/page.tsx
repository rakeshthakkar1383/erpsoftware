...
import { getAllLeaves, addLeave, getAllTeachers, getAllLeaveTypes, getAllSchools, getAllTrusts } from "../actions"
...
export default function TeacherLeavePage() {
  ...
  const refreshLeaves = async () => {
    ...
    setMyLeaves(all.filter((l: any) => l.applicant_type === "teacher"))
  }
  ...
  const handleSubmit = async () => {
    ...
    Object.entries({ ...form, applicant_type: "teacher" }).forEach(([k, v]) => fd.append(k, String(v ?? "")))
  ...
  return (
    <div className="max-w-4xl mx-auto">
      <div className="mb-6 flex items-center justify-between">
        <h2 className="text-2xl font-semibold">Teacher Leave Form</h2>
