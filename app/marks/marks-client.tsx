...
export default function MarksClient({ initialMarks, students, exams, divisions, teacherSubjects, teacherClass }: { initialMarks: any[], students: any[], exams: any[], divisions: any[], teacherSubjects: any[], teacherClass: string }) {
